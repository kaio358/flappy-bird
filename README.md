...
# flappy-bird
 ...
 - spritesX: ? ; -> Indica a parte horizontalmente da imagem que queira
   retirar. A conveção do nome é devido nome do arquivo (sprites.png)
 - spritesY: ? ; -> Indica a parte verticalmente da imagem que queira
   retirar. A conveção do nome é devido nome do arquivo (sprites.png)
  
 - largura: ? ; -> Indica a largura do frame da imagem que será
   retirada.
